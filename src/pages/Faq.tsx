      ...
      <Grid container spacing={{ xs: 4, md: 8 }} alignItems="flex-start">
        <Grid size={{ xs: 12, md: 4 }}>
          <Box sx={{ position: { md: 'sticky' }, top: { md: 112 } }}>
            ...
            <Stack spacing={1.25} alignItems="flex-start"><Button to="/contact">Book a Demo <ArrowUpRight size={16} /></Button><Button to="/how-it-works" variant="ghost">See how it works</Button></Stack>
